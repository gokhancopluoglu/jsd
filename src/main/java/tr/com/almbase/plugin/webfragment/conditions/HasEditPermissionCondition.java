 ...
 */
public class HasEditPermissionCondition implements com.atlassian.plugin.web.Condition {
    private static final Logger log = LoggerFactory.getLogger(HasEditPermissionCondition.class);

    private RestrictedProjectController restrictedProjectController;

    private HasEditPermissionCondition(RestrictedProjectController restrictedProjectController) {
