...
public class SendMailToGroupMembersFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory
{
    public SendMailToGroupMembersFactory() {
    }
